...
/**
 * Stable field ids used for mapping dialog validation messages to controls.
 */
public final class DialogFieldIds {
    ...
    public static final String PROFILE_PASSWORD_NEW = "profilePasswordNew";
    public static final String PROFILE_PASSWORD_CONFIRM = "profilePasswordConfirm";

    private DialogFieldIds() {
    }
}
